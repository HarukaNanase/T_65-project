...
import pt.upa.broker.ws.cli.FrontEndBroker;
...
public class AbstractTest {
	...
	protected static FrontEndBroker CLIENT;
	...
	public static void oneTimeSetup() throws Exception {
		...
		try {
            PROPS.load(AbstractTest.class.getResourceAsStream(TEST_PROP_FILE));
		...
		if ("true".equalsIgnoreCase(uddiEnabled)) {
			CLIENT = new FrontEndBroker(uddiURL, wsName);
		} else {
			CLIENT = new FrontEndBroker(wsURL);
		}
